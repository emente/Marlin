...
#define STRING_CONFIG_H_AUTHOR "(mnt)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {32*2,32*2,1337*2,380*2}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {150, 310, 5, 35}    // (mm/sec)
